...
import br.com.boletim.backend.dto.ErrorResponseDTO;
...
public class NotaController {
    ...
    @PostMapping("/lote")
    @Operation(summary = "Salvar notas em lote", description = "Salva múltiplas notas de forma atômica. Se uma nota for inválida, nenhuma será salva.")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Todas as notas foram salvas com sucesso"),
        @ApiResponse(responseCode = "400", description = "Dados de validação inválidos. Nenhuma nota foi salva.",
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Notas do aluno recuperadas com sucesso"),
